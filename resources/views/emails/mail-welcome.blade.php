                        ...
                        <tr style="vertical-align:middle;" valign="middle">
                            <td align="center" style="padding:30px;" class="content">
                                <table align="center" role="presentation" border="0" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr style="vertical-align:middle;" valign="middle">
                                        <td class="content">
                                            <img src="https://bedlink.id/img/ui/logo-bedlink.png"><br><br>
                                            <p
                                                style="color:#000000;font-size:18px;mso-line-height-rule:exactly;line-height:24px;font-family:Arial,sans-serif;margin-top:0!important;font-weight:bold;">
                                                Hi {{ $user->name }}! Terima Kasih Telah Bergabung!</p>
                                            <p
                                                style="color:#000000;font-size:16px;mso-line-height-rule:exactly;line-height:24px;font-family:Arial,sans-serif;">
                                                Kamu telah terdaftar di Bedlink. Silahkan klik tombol di bawah ini untuk
                                                mengakses hakaman dashboard kamu dan mulai menambahkan link!</p>
                                            <p
                                                style="color:#000000;font-size:16px;mso-line-height-rule:exactly;line-height:24px;font-family:Arial,sans-serif;">
                                                <a href="http://bedlink.id/dashboard/edit-link"
                                                    style="font-size:16px;mso-line-height-rule:exactly;line-height:24px;font-family:Arial,sans-serif;text-decoration:underline;font-weight:bold;color:#0000ff;">Menuju
                                                    Dashboard</a>
                                            </p>
                                            <p
